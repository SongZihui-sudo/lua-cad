 ...
 * @LastEditTime: 2024-02-11 22:49:36
...
#define CYLINDER_EXPORT_ARGS( self )                                                       \
    CYLINDER_H( self ), CYLINDER_NAME1(self), CYLINDER_R_D_1( self ), CYLINDER_NAME2(self), IS_CENTER( self->base.m_center )
...
#define SPHERE_EXPORT_ARGS( self ) SPHERE_NAME(self), SPHERE_R_OR_D( self )
...
#define POLYHEDRON_EXPORT_ARGS( self ) POLYHEDRON_NAME1(self), POLYHEDRON_NAME1(self), POLYHEDRON_CONVEXITY(self)
...
#define POLYGON_EXPORT_ARGS( self ) POLYGON_NAME1(self), POLYGON_NAME1(self), POLYGON_CONVEXITY(self)
